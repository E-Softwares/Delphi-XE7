...
Function GetUniqueFilename(Const aFolder: String; aExtn: String; Const aPrefix: String = String.Empty): String;
...
Begin
   Result := String.Empty;
   If Trim(aFolder).IsEmpty Or Not DirectoryExists(aFolder) Then
